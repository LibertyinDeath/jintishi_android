...
public class QueryActivity_qyls extends Activity{
	List<JintishiInfo> JintishiInfoList;
	
	protected void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.query_qyls_layout);
		...
		Cursor cursor=db.query("QYLS", null, null, null, null, null, null);
		if(cursor.moveToFirst()){
			...
			cursor.close();
			LinearLayout ll=(LinearLayout)findViewById(R.id.ll_qyls);
		...
		query_wyjj.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(QueryActivity_qyls.this,QueryActivity_wyjj.class);
		...
		query_qyjj.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_qyls.this,QueryActivity_qyjj.class);
				startActivity(intent);
			}
		});
		...
		query_wyls.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_qyls.this,QueryActivity_wyls.class);
				startActivity(intent);
			}
		});
		...
		query_qyls.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_qyls.this,QueryActivity_qyls.class);
				startActivity(intent);
			}
		});
		
		//创作界面
		Button create=(Button)findViewById(R.id.button_create_qyls);
		create.setOnClickListener(new  OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_qyls.this,CreateqiyanlvshiActivity.class);
				startActivity(intent);
			}
		});
		...
		returnmain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_qyls.this,CreateqiyanjuejuActivity.class);
				startActivity(intent);
			}
		});
	}
