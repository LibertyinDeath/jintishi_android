...
public class QueryActivity_wyjj extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
		...
		setContentView(R.layout.query_wyjj_layout);
		...
		Cursor cursor=db.query("WYJJ", null, null, null, null, null, null);
		if(cursor.moveToFirst()){
			...
			cursor.close();
			LinearLayout ll=(LinearLayout)findViewById(R.id.ll_wyjj);
		...
		query_wyjj.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(QueryActivity_wyjj.this,QueryActivity_wyjj.class);
		...
		query_qyjj.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_wyjj.this,QueryActivity_qyjj.class);
				startActivity(intent);
			}
		});
		...
		query_wyls.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_wyjj.this,QueryActivity_wyls.class);
				startActivity(intent);
			}
		});
		...
		query_qyls.setOnClickListener(new  OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_wyjj.this,QueryActivity_qyls.class);
				startActivity(intent);
			}
		});
		
		//创作界面
		Button create=(Button)findViewById(R.id.button_create_wyjj);
		create.setOnClickListener(new  OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_wyjj.this,CreateActivity.class);
				startActivity(intent);
			}
		});
		...
		returnmain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(QueryActivity_wyjj.this,CreateqiyanjuejuActivity.class);
				startActivity(intent);
			}
		});
	}
