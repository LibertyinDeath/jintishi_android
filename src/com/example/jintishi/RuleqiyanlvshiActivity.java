...
public class RuleqiyanlvshiActivity extends Activity{
	@Override
	protected void onCreate(Bundle savedInstanceState){
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.rule_qiyanlvshi_layout);
		...
		returnmain.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent=new Intent(RuleqiyanlvshiActivity.this,BackgroundActivity.class);
		...
		createwuyanjueju.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(RuleqiyanlvshiActivity.this,RulewuyanjuejuActivity.class);
				startActivity(intent);
		...
		createqiyanjueju.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(RuleqiyanlvshiActivity.this,RuleqiyanjuejuActivity.class);
				startActivity(intent);
		...
		createwuyanlvshi.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(RuleqiyanlvshiActivity.this,RuleqiyanlvshiActivity.class);
				startActivity(intent);
			}
		});
		...
		create.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(RuleqiyanlvshiActivity.this,CreateqiyanlvshiActivity.class);
				startActivity(intent);
			}
		});
	}
